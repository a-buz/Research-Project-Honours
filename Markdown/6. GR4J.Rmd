...
for (i in 1:length(river.list)) {
  ...
  river.number <- as.character(unlist(strsplit(river.list[i], '.csv')))
  header <- read_csv(paste0('../Data/Rivers/', river.number, ".csv", sep = ""), n_max = 26, col_names = F)
